...
--9
SELECT SUM(budget) AS totalcost FROM departments;
--10
...
--13
SELECT employees.name, employees.lastname FROM employees JOIN departments ON employees.department = departments.code ORDER BY departments.budget ASC LIMIT 1;
--14
SELECT employees.name AS e_name, customers.name AS c_name FROM employees JOIN customers ON employees.city = customers.city WHERE employees.city = 'Almaty';
--15
